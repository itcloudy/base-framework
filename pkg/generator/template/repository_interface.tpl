...
type I{{.ModelName}}Repository interface {
	...
	// 创建
	Insert{{.ModelName}}(DB *gorm.DB, model models.{{.ModelName}}Create) (result models.{{.ModelName}}Detail, err error)
	// 修改
	Update{{.ModelName}}(DB *gorm.DB, model models.{{.ModelName}}Update) (result models.{{.ModelName}}Detail, err error)
	// 删除
